...
mysqli_query($conexao,"INSERT INTO trabalheconosco (cidade,cpf,email,estado,nome,genero,data,escolaridade)values ('$cidade','$cpf','$email','$estado','$nome','$genero','$data','$escolaridade')"); 
